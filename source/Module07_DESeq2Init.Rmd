...
Alternatively, we can manually create a sample sheet, ensuring that the sample IDs match our count table.
...
The design formula specified informs many of the DESeq2 functions how to treat the samples in the analysis, specifically the relevant column(s) in the metadata table and how they should be used in the analysis. 
